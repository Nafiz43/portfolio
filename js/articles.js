    ...
    const articles = [
        {
            ...
            "year": "2025",
            "image": "img/ossprey-dashboard-2.png",
        ...
        },
        {
            ...
            "link": "https://dl.acm.org/doi/10.1145/3696630.3728607",
            "authors": "<b>Nafiz Imtiaz Khan</b>, Vladimir Filkov",
            "venue": "FSE 2025 Tool Demonstrations (Foundations of Software Engineering)",
            "year": "2025",
            "image": "img/EvidenceBot_UI.png",
        ...
        },
        {
          ...
          "link": "https://onlinelibrary.wiley.com/doi/full/10.1002/eng2.12572",
          "authors": "Md Mahbubar Rahman, <b>Nafiz Imtiaz Khan</b>, Iqbal H. Sarker, Mohiuddin Ahmed, and Muhammad Nazrul Islam",
            "venue": "Engineering Reports",
            "year": "2022",
          "image": "img/leveraging.jpg",
      ...
      const articleHTML = `
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5 ${isOdd ? 'flex-md-row-reverse' : ''}">
          ...
          <div class="resume-content">
            ...
            <div class="text-muted mb-3">Venue: ${article.venue || 'To be announced'}${article.year ? ' (' + article.year + ')' : ''}</div>
